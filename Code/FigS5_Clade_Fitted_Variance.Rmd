...
write_csv(cct, here("Cranial_Data", "Clade_Cranial_Variance_Weighted.csv"))
...
write_csv(cct, here("Dentary_Data", "Clade_Dentary_Variance_Weighted.csv"))
```
...
write_csv(eet, here("External_Measurement_Data", "Clade_External_Variance_Fitted.csv"))
```
...
write_csv(ist, here("Isotope_Data", "Clade_Isotope_Fitted.csv"))
```
...
dat %>% write_csv(here("Plots", "Clade_Varaince.csv"))
rm(cct, ddt, ext, ist)
```
...
write_csv(lst, here("Locomotion_Data", "Clade_Locomotion_Var.csv"))
```
...
dat <- read_csv(here("Plots", "Clade_Varaince.csv"))
...
ggsave(here("Plots", "FigS3_Clade_Var_Plots_2.pdf"), height = 23.25, width =12)
#without ear and loc
