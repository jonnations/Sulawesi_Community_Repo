...
ggsave(here("Plots", "Fig3A_V_SES_Regression_Magma.pdf"), width = 6, height = 10, useDingbats = F)
```
...
ggsave(here("Plots", "Fig3B_NN_SES_Regression_Magma.pdf"), width = 6, height = 10, useDingbats = F)
```
