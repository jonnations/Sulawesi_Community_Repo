...
*Important* : NRI is obtained by multiplying the standardized effect size mean phylogenetic (pairwise) distances (calculated via a null model of interest) by −1.
```{r}
set.seed(111)
